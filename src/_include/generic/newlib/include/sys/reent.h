...
#define _REENT_INIT_MISC(var) do { \
  ...
  _r->_misc->_mblen_state.__data.__wch = 0; \
  _r->_misc->_wctomb_state.__count = 0; \
  _r->_misc->_wctomb_state.__data.__wch = 0; \
  _r->_misc->_mbtowc_state.__count = 0; \
  _r->_misc->_mbtowc_state.__data.__wch = 0; \
  _r->_misc->_mbrlen_state.__count = 0; \
  _r->_misc->_mbrlen_state.__data.__wch = 0; \
  _r->_misc->_mbrtowc_state.__count = 0; \
  _r->_misc->_mbrtowc_state.__data.__wch = 0; \
  _r->_misc->_mbsrtowcs_state.__count = 0; \
  _r->_misc->_mbsrtowcs_state.__data.__wch = 0; \
  _r->_misc->_wcrtomb_state.__count = 0; \
  _r->_misc->_wcrtomb_state.__data.__wch = 0; \
  _r->_misc->_wcsrtombs_state.__count = 0; \
  _r->_misc->_wcsrtombs_state.__data.__wch = 0; \
...
# define _impure_tls /**/
#else
# define _impure_tls _tls_decl
# endif

extern struct _reent _impure_tls * __ATTRIBUTE_IMPURE_PTR__ _thread_impure_ptr;
extern struct _reent             * __ATTRIBUTE_IMPURE_PTR__ _global_impure_ptr;

extern struct _reent * (*_thread_impure_ptr_thunk)(void);
extern struct _reent * (*_global_impure_ptr_thunk)(void);

void _reclaim_reent _PARAMS ((struct _reent *));

#define _REENT_       (_thread_impure_ptr_thunk ? (*_thread_impure_ptr_thunk)() : _thread_impure_ptr)
#define _GLOBAL_REENT (_global_impure_ptr_thunk ? (*_global_impure_ptr_thunk)() : _global_impure_ptr)

#if !defined(__linux__) && !defined(_M_LINUX)
# define _REENT (_REENT_)
#else
# define _REENT (_tls_valid ? ((struct _reent *) _tls_get_data()->impure) : _REENT_)
# endif
