...
char *	_EXFUN(mktemp,(char *) _ATTRIBUTE ((__deprecated__())));
#endif
#endif /* !_REENT_ONLY */
...
char *	_EXFUN(_mktemp_r, (struct _reent *, char *) _ATTRIBUTE ((__deprecated__())));
...
int	_EXFUN(setenv,(const char *__string, const char *__data, int __overwrite));
#endif
int	_EXFUN(_setenv_r,(struct _reent *, const char *__string, const char *__data, int __overwrite));
